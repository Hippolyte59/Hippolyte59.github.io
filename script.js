const templates = [
    ...
    { id: 2, name: "Dashboard Analytics Premium", category: "dashboard", description: "Graphiques, filtres et KPI prêts à intégrer.", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&auto=format&fit=crop&q=80", demoUrl: "./NovaBoard", technologies: ["Html5", "CSS3", "Javascript"], rating: 4.95 },
